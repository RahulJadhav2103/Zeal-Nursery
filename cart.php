...
<html>
    ...
    <body>
        <div>
            ...
            ?>
            <br>
            <div id="bannerImage" style="padding-bottom: 453px;">
            <div class="container">
                <div class="row">
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th><th><a href="payment.php?id=<?php echo $sum?>" class="btn btn-primary">Confirm Order </a></th>
                            </tr>
                        </tbody>
                    </table>
                </div>
