                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $sum?>" name="amount" />
                                </div>
                            </div>                        
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                            <a href="success.php" class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Payment</a>
